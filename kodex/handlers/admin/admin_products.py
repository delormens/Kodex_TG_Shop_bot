...
from kodex.keyboards.inline_admin import (category_edit_open_finl, position_edit_open_finl, category_edit_delete_finl,
                                          position_edit_clear_finl, position_edit_delete_finl,
                                          position_edit_cancel_finl, category_edit_cancel_finl)
from kodex.keyboards.inline_main import (category_remove_confirm_inl, position_remove_confirm_inl,
                                         item_remove_confirm_inl, close_inl)
from kodex.keyboards.inline_page import *
from kodex.keyboards.reply_main import finish_load_rep, items_frep
from kodex.middlewares.throttling import rate_limit
from kodex.services.api_session import AsyncSession
from kodex.services.api_sqlite import *
from kodex.utils.const_functions import clear_list, is_number, to_number
from kodex.utils.misc.bot_filters import IsAdmin
from kodex.utils.misc_functions import get_position_admin, upload_text, upload_photo
...
async def product_position_create_photo(message: Message, state: FSMContext):
    ...
    if "text" not in message:
        ...
        kodex_one: AsyncSession = message.bot['kodex_one']

        position_photo = await upload_photo(kodex_one, photo_path)
