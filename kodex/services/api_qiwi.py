...
from kodex.keyboards.inline_main import close_inl
from kodex.services.api_qiwip2p import QiwiAPIp2p
from kodex.services.api_session import AsyncSession
from kodex.services.api_sqlite import update_paymentx, get_paymentx
from kodex.utils.const_functions import ded
from kodex.utils.misc_functions import send_admins
...
class QiwiAPI:
    ...
    async def _request(self, action, version, get_way, params=None, without=False):
        ...
        kodex_one: AsyncSession = self.dp.bot['kodex_one']
